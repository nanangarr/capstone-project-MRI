...
export default function Home() {
  ...
  return (
    <>
      <div className="flex flex-col h-full space-y-20 px-8 sm:px-8 md:px-20 py-12 md:py-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex flex-col w-full">
            <h1 className="text-2xl sm:text-3xl md:text-3xl font-bold text-start mb-4">
              Tutorial Penggunaan
            </h1>
      ...
      {/* Testimoni */}
      <div className="px-8 sm:px-8 md:px-20 py-12 md:py-16">
